...
- HTML mendukung format penulisan warna tidak hanya dengan nama warna nya (red, blue, green), namun juga dengan format
 penulisan seperti HEX, RGB, HSL dan lain-lain
- Dengan begitu, penulisan warna jadi lebih akurat dibandingkan hanya dengan nama warna nya

Color Picker

- Salah satu website yang bisa kita gunakan untuk memilih warna adalah : z/ 
